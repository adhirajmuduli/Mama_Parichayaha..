...
export const chapterRegistry = [
  {
    ...
    scene: {
      ...
      atmosphere: {
        ...
        palette: ['#05070D', '#151B33', '#D97745'],
        particleColor: '#E8DDD0',
        particleOpacity: 0.28,
      },
      haloColor: '#C17A3A',
      environmentColor: '#05070D',
    },
  },
  {
    id: 'interests',
